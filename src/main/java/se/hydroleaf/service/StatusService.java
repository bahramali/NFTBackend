...
public class StatusService {
    ...
    public LiveNowSnapshot getLiveNowSnapshot() {
        ...
        Map<String, SystemData> systems = Stream
                ...
                .filter(r -> r.system() != null && !r.system().isBlank() && r.layer() != null && !r.layer().isBlank())
    ...
    private class SystemData {
        ...
        void accumulate(LiveNowRow row) {
            ...
            boolean actuator = isActuator(row.sensorType());
            ...
            layer.values.put(row.sensorType(), resp);

            SumCount sc = totals.computeIfAbsent(row.sensorType(), t -> {
