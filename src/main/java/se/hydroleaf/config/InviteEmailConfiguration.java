...
import se.hydroleaf.service.InMemoryInviteEmailService;
...
public class InviteEmailConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean(InviteEmailService.class)
    public InviteEmailService inMemoryInviteEmailService() {
        return new InMemoryInviteEmailService();
    }
}
