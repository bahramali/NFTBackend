...
public class AdminCustomerController {
    ...
    public CustomersPageResponse list(
        ...
        log.info("AdminCustomerController request start requestId={} method={} path={} query={}",
                requestId,
                request.getMethod(),
                fullPath,
                query == null ? "" : query);
        ...
        log.info("AdminCustomerController request complete requestId={} status=200 page={} size={} totalItems={}",
                requestId,
                response.getPage(),
                response.getSize(),
